...
public let COULD_NOT_CONVERT_IMG_ERROR = "Couldn't convert the image to a URL"
public let COULD_NOT_CREATE_FILE_URL_ERROR = "Couldn't create file url"
...
public let COULD_NOT_FIND_ITEM_ERROR = "Couldn't find the item attached to this share"
